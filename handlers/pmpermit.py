...
Alive_msg = f"ᴍᴜᴋʜᴜsʜɪ ᴘʀɪᴠᴀᴛᴇ ᴘʀᴏᴛᴇᴄᴛɪᴏɴ🔱 \n\n"
Alive_msg += f"◈ ━━━━━━ ◆ ━━━━━━ ◈ \n"
Alive_msg += f"► ᴠᴇʀsɪᴏɴ : `Beta.0.1` \n"
Alive_msg += f"► ᴘʏʀᴏ ᴠᴇʀsɪᴏɴ : `1.4.15` \n"
Alive_msg += f"► Rᴇᴘᴏ : [Gɪᴛʜᴜʙ](https://github.com/Itz-mst-boy/mukhushi-userbot) \n"
Alive_msg += f"► Sᴜᴘᴘᴏʀᴛ : [Jᴏɪɴ.](https://t.me/worldwide_friend_zone) \n"
Alive_msg += f"► Cʜᴀɴɴᴇʟ : [Jᴏɪɴ.](https://t.me/mastermind_network_official) \n"
